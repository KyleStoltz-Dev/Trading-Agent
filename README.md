...
“analyze my copied chart” without the shortcut. `trade chart --clipboard` remains available as a
direct-command fallback. Clipboard capture accepts only PNG, JPEG, or WebP bytes up to 10 MB and
