...
DIRECT_ACTION_METADATA = {
    ...
    "configure_telegram_secret": {"mutating": True, "deterministic": False},
    "configure_discord_secret": {"mutating": True, "deterministic": False},
    ...
    "customize_dashboard": {"mutating": False, "deterministic": False},
    "get_agent_context": {"mutating": False, "deterministic": False},
    "list_agent_providers": {"mutating": False, "deterministic": False},
    "list_agent_models": {"mutating": False, "deterministic": False},
    "configure_agent_provider": {"mutating": True, "deterministic": False},
    ...
    "list_market_instruments": {"mutating": False, "deterministic": False},
    ...
    "import_tradingview_history": {"mutating": True, "deterministic": False},
