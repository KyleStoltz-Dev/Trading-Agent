...
from app.models import EconomicEvent, MindsetCheckIn, PretradeAssessment, TradePlan
from app.schemas import MindsetCheckInCreate, TradePlanCreate
...
def test_blocked_assessment_cannot_finalize_as_proceed(db_session) -> None:
    version = create_playbook_version(
        db_session,
...
def test_preflight_orchestration_rolls_back_every_record_on_failure(db_session) -> None:
...
def test_preflight_orchestration_commits_one_consistent_audit(db_session) -> None:
