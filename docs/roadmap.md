...
- prefer the configured 9B Ollama profile for routine local work on a 48 GB machine;
- treat the 35B-A3B Ollama profile as an explicit, resource-guarded quality option rather than
  a continuously resident default, especially under swap pressure;
...
### 3. Numeric bridge from visual concepts to evidence
...
### 4. Daily and weekly desk outlook
...
### 5. Replay and forward-test engine
